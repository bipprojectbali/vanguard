...
INSERT INTO customer_success (
    ...
    sqlc.narg(previous_health_score), sqlc.narg(previous_health_calculated_at),
...
UPDATE customer_success SET
    ...
    previous_health_score          = sqlc.narg(previous_health_score),
    previous_health_calculated_at  = sqlc.narg(previous_health_calculated_at),
