...
func TestWorkspaceNav_EnglishTopLevel(t *testing.T) {
	nav := workspaceNav("acme", true, true, true, true, true, true, true, true, true, true, true, true, true)
...
func TestWorkspaceNav_SalesGroup(t *testing.T) {
	...
	nav := workspaceNav("acme", false, false, false, false, true, true, true, false, false, false, false, false, false)
	...
	navNone := workspaceNav("acme", false, false, false, false, false, false, false, false, false, false, false, false, false)
...
func TestWorkspaceNav_SubscriptionsGroup(t *testing.T) {
	...
	nav := workspaceNav("acme", false, false, false, false, false, false, false, true, true, false, false, false, false)
...
// (slice A3, enabled mengikuti canKB) berbackend — 8 anak lain SELALU disabled
// apa pun izinnya, karena slice-nya belum mendarat.
func TestWorkspaceNav_CSGroup(t *testing.T) {
	...
	// canSLA=true & canPlaybooks=true & canKB=true → grup tampil, ketiganya
	// enabled dengan href benar.
	nav := workspaceNav("acme", false, false, false, false, false, false, false, false, false, true, true, true, false)
	...
	// canSLA=false & canPlaybooks=false & canKB=false → grup tetap tampil,
	// ketiganya disabled tanpa href (menu tak menawarkan pintu yang lalu
	// ditolak 403).
	navNone := workspaceNav("acme", false, false, false, false, false, false, false, false, false, false, false, false, false)
...
func TestWorkspaceNav_SettingsGatingPerIzin(t *testing.T) {
	...
	nav := workspaceNav("acme", false, false, false, false, false, false, false, false, false, false, false, false, true)
	grp, ok := findItem(nav, "Settings")
	if !ok {
...
func TestWorkspaceNav_NoSettingsGroupWithoutPerms(t *testing.T) {
	nav := workspaceNav("acme", false, false, true, true, false, false, false, false, false, false, false, false, false)
...
func TestWorkspaceNav_HrefSlugBenar(t *testing.T) {
	nav := workspaceNav("beta", true, true, true, true, true, true, true, true, true, true, true, true, true)
