...
// Adoption) + 403, dipisah dari customer_success.go (file health, ambang
// Route/Handler 150). SATU baris `customer_success` per desa tapi TIGA objek
// Casbin berbeda; lihat customer_success.go untuk rasional lengkap.
