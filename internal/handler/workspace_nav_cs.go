...
// Selalu tampil (peta jalan produk terlihat, "nol menu hantu"): 11 anak
// URUT PERSIS wireframe (6.1 → 6.11), hanya SLA Management berbackend sejak
// slice A1 — sisanya placeholder disabled sampai slice-nya sendiri mendarat
// (A2 Playbooks, A3 KB Articles, B1 Health/Journey/Adoption, C1 Onboarding,
// C2 Success Plans, C3 Surveys, D1 Tickets).

// workspaceCSGroup merakit grup Customer Success (wireframe 6). canSLA =
// canViewSLAPolicies (izin SAMA dengan gerbang SLAPoliciesList).
func workspaceCSGroup(slug string, canSLA bool) ui.NavItem {
	...
	children = append(children,
		...
		ui.NavItem{Label: "Playbooks", Icon: lucide.BookOpen(html.Class("size-4")), Disabled: true},
