...
// roles_permset.go — matriks blok B (permissionSetRows/crudMark/
// buildPermissionSetView), opsi cakupan bisnis, dan pemetaan pesan untuk
// halaman /roles. Dipisah dari roles_card.go krn ambang File Health
