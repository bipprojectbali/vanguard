...
// jena_ai_tools_sales_search.go — tool search_deals/search_leads (BL-162 fase
// 3), dipisah dari jena_ai_tools_sales.go agar file itu di bawah ambang tipe
// Route/Handler (150). Sama aturan F2/F3/F4 dari jena_ai_tools_sales.go —
// bedanya F3 di sini MENGIKUTI data_scope penanya apa adanya, bukan dipaksa
// own (lihat rasional lengkap di header jena_ai_tools_sales.go).
