...
func workspaceNav(slug string, canMembers, canSettings, canAccounts, canContacts, canLeads, canDeals, canSalesActivity, canPlans, canSubs, canSLA, canPlaybooks, canKB, canRoles, canTickets, canHealthScore bool) []ui.NavItem {
	items := []ui.NavItem{
	...
	items = append(items, workspaceCSGroup(slug, canSLA, canPlaybooks, canKB, canTickets, canHealthScore))
