...
// regionsJSON mengambil SELURUH master wilayah level 1-3 (~7.837 baris, tabel
// GLOBAL tanpa tenant_id/RLS — lihat regions.sql) & marshal ke JSON siap-embed utk
