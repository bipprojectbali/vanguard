...
// TERBARU satu desa). MRR & ARR SEJAK BL-169 memakai kapabilitas Casbin yang
// SAMA (crm:subscriptions/arr, canSeeSubscriptionARR) — dihitung SEKALI di
// sini (bukan dioper dari pemanggil) krn ctx sudah tersedia & tak ada guna
// lagi membedakan br per field (sebelum BL-169, MRR ikut F4/allow-list nama
// role sementara ARR ikut F2/Casbin — BL-166 sudah menyinkronkan keduanya
// dalam kartu ini, BL-169 menyinkronkan sumbernya di seluruh app).
func (h *Handler) subscriptionSummaryFor(ctx context.Context, base string, accountID int64) panel.SubscriptionSummaryView {
