...
// changelog_archive.go — rilis versi lama (1.0.0-1.4.0), dipisah dari
// changelog.go krn ambang File Health (Service/Lainnya 300 baris). Isi APA
// ADANYA, hanya dipindah; Releases (changelog.go) = append(currentReleases,
// archivedReleases...) supaya urutan TERBARU DI INDEKS 0 tetap sama.
var archivedReleases = []Release{
	{
		Version: "1.4.0",
		Date:    "2026-09-11",
